...
export const planetImages = {
    ...
    // Yavin IV
    "3": "https://lumiere-a.akamaihd.net/v1/images/yavin-4-main_bd23f447.jpeg?region=331%2C0%2C949%2C534g", 
    // Hoth
...
export const vehicleImages = {
    ...
    // T-16 skyhopper
    "6": "https://lumiere-a.akamaihd.net/v1/images/t-16-skyhopper-model-main_627b6185.jpeg?region=0%2C7%2C818%2C460", 
    // X-34 landspeeder
    "7": "https://lumiere-a.akamaihd.net/v1/images/E4D_IA_1136_6b8704fa.jpeg?region=237%2C0%2C1456%2C819", 
    // TIE/LN starfighter
    "8": "https://lumiere-a.akamaihd.net/v1/images/TIE-Fighter_25397c64.jpeg?region=0%2C1%2C2048%2C1152", 
    // Snowspeeder
    ...
    // AT-ST
    "19": "https://lumiere-a.akamaihd.net/v1/images/tlj-first-order-atst_dd236e34.jpeg?region=0%2C0%2C1560%2C878", 
    ...
    // Sail barge
    "24": "https://lumiere-a.akamaihd.net/v1/images/open-uri20150608-27674-168ubjg_976dbf1d.jpeg?region=0%2C0%2C1200%2C506"
};

export const getImageUrl = (category, id) => {
    const mappings = {
        people: characterImages,
        planets: planetImages,
        vehicles: vehicleImages,
    };

    const categoryMappings = mappings[category];
    return categoryMappings?.[id] ;
};
